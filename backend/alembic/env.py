...
Similar to Laravel's DatabaseSeeder - handles migrations
"""
...
from app.models import Project, Video, Clip, Subtitle  # Import all models
...
def run_migrations_offline() -> None:
    ...
    Similar to: php artisan migrate --pretend
    """
...
def run_migrations_online() -> None:
    """
    Run migrations in 'online' mode (connects to DB and runs)
